...
@ThreadSafe
public class DoublePrimitiveGetterSetterTester {

	private static final Double[] values = new Double[] { Double.MIN_VALUE, -1.0, 0.0, 1.0, 1.2344532, Double.MAX_VALUE };
	private static final ImmutableList<Double> DoubleValues = ImmutableList.copyOf(values);
	...
	public static DefaultGetterSetterTester<Double> createTester(
			Class<?> classUnderTest,
			@Nullable Object instanceUnderTest,
			String fieldName) {
		return new DefaultGetterSetterTester<Double>(classUnderTest,
				instanceUnderTest,
				fieldName,
				double.class,
				DoubleValues);
