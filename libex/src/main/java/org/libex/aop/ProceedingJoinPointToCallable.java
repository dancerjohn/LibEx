 ...
 * 
 * This class can be used in conjuction with {@link org.libex.concurrent.profile.Profiler} to profile method calls.
 * 
...
public class ProceedingJoinPointToCallable {
	...
	public ProceedingJoinPointToCallable(final Caller caller) {
		super();
		this.caller = caller;
	}
