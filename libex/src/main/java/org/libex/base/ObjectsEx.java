...
public final class ObjectsEx {
    ...
    /**
     * Converts object instances to String using the object's {@code toString()} method. If null is passed, null is
     * returned.
     * 
     * @return a Function that converts object instances to String using the object's {@code toString()} method
     */
    @Nonnull
     ...
     * 
     * @return a Function that returns the result of calling {@code toString} on
     *         the passed instance or the {@code defaultValue} if {@code object} is
     *         null
     ...
     * @return the result of calling {@code toString} on the passed instance, {@code defaultValue} if null is passed
     */
    @Nonnull
    public static String toString(@Nullable final Object object,
            @Nonnull final String defaultValue) {
    ...
    @Nullable
    public static <T> T firstNotNull(@Nullable final T first, @Nullable final T second) {
