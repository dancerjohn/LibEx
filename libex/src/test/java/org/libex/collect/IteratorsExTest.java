...
import static org.libex.collect.IteratorsEx.*;
...
public class IteratorsExTest extends TestBase {
	...
	public static class FindFirstTest extends TestBase {
		...
		public void testFindFirst_nullArg() {
			...
			Optional<Integer> result = findFirst(null, newArrayList(present1, absent3).iterator());
		...
		public void testFindFirst_emptyList() {
			// test
			Optional<Integer> result = findFirst("", Lists.<Function<Object, Optional<Integer>>> newArrayList().iterator());
		...
		public void testFindFirst_notFound() {
			// test
			@SuppressWarnings("unchecked")
			Optional<Integer> result = findFirst("", newArrayList(absent1, absent2, absent3).iterator());
		...
		public void testFindFirst_found() {
			// test
			@SuppressWarnings("unchecked")
			Optional<Integer> result = findFirst("", newArrayList(absent1, absent2, present1, absent3, present2).iterator());
